 ...
 *  Do not edit this file directly — except the open-modal steps below, which
 *  are required because this preview starts with the dialog closed; the aria
 *  snapshot matches the open non-blocking dialog.
 */
