      ...
      <Host>
        <ix-tab-panels>
          ...
          >
            ...
            <ix-tab-item icon={iconAdd} tabKey="tab-7">
              Tab Item 7
            </ix-tab-item>
            <ix-tab-item icon={iconAdd} tabKey="tab-8">
              Tab Item 8
            </ix-tab-item>
            <ix-tab-item icon={iconAdd} tabKey="tab-9">
              Tab Item 9
            </ix-tab-item>
            <ix-tab-item icon={iconAdd} tabKey="tab-10">
              Tab Item 10
            </ix-tab-item>
            <ix-tab-item icon={iconAdd} tabKey="tab-11">
              Tab Item 11
            </ix-tab-item>
          </ix-tabs>
